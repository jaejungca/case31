...
Participants perceived Employee proficiency (*M* = `4.21` out of 5.0) is statistically significantly greater than 4.0 (`"Agree"`)
:::
...
-   `Constructs and roles`:
    ...
    2.  
        (a) Confidentiality of personal financial information (IV)
    3.  
        (b) Loan application processing promptness (IV)
    4.  
        (c) Adequacy of financial services in meeting needs (IV)
    5.  
        (d) Simplicity and easiness of loan application (IV)
:::
