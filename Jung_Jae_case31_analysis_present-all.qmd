...
::: {style="font-size: 1.5em; text-align: center" .incremental}
...
::: {.aside}
_**Notes**_: The research objectives were developed by the board
:::

::: {.notes}
My speaker notes go here
Press "s" on your keyboard to create a speaker view slide that you can see on the other screen
:::
...
- Assumptions of multiple regression are not violated severely. 
...
-   As expected, `confidentiality` (*p* < .05), l`oan application process` (*p* < .001) and `adequacy of financial resources` (*p* < .001) are positively related to the overall efficiency.
-   `Simplicity and easiness of loan application` is not significantly related to the overall efficiency (_p_ > .10)
